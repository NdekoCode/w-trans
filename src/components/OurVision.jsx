  ...
  return (
    <section className="section" id="more">
      <div className="container flex flex-col items-center py-12 mx-auto sm:py-24">
        ...
        <div className="flex flex-wrap justify-center my-10 space-x-3">
          <div className="w-full lg:w-3/12 px-4 text-center mb-5 py-10 rounded-xl bg-white shadow-md ">
            <div className="text-primary-dark p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
            ...
            <h5 className="text-2xl mt-5 font-semibold text-primary-dark">
